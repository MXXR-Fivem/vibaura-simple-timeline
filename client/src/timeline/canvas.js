...
import { MS_DAY, MONTHS, fmtDateShort } from '../lib/dates.js'
...
export function computeTicks(t0, t1, ppd) {
...
// ---------- scène complète ----------
export function drawScene(ctx, { w, h, ppd, mode, startMs, endMs, hoverX, xOf, tOf }) {
  if (!w || !h) return
